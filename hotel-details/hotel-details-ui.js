...
/>
    */}
<EText h4 style={styles.tilesWhole}>Mappilllai Virunthu</EText>
...
<View style={{flex: 3, flexDirection: 'row', justifyContent: 'space-between'}}>
        ...
        <EText style={{alignItems : "center",fontWeight: "bold"}}>4.2</EText>
...
<EText style={{margin:10}}> 50% off up to $100 on orders above $129. | Use coupan SWIGY</EText>
...
<Image style={{height:50,width: 50, alignContent: "flex-end"}} source={{uri : 'https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_400,h_400/HygieneGoodWhite_kviidn'} }/>
</View>
<Divider style={{ backgroundColor: '#CDCDCD',marginEnd:10,marginStart:10 }} />

<EText h4 style={{marginStart: 10,marginTop:10}}> Recommended</EText>
...
<EText h4 style={{marginStart: 10,marginTop:10}}>Internation Cuisine</EText>
...
<FlatList
        ...
        renderItem={({ item }) => (
          ...
          <View style={{flexDirection: "row"}}>
          <Image  style={{height:50,width:50,  alignItems : "flex-start"}} source={{uri: item.imgURL }} />
         
           <View style={{flexDirection: "column",marginStart: 10,marginBottom: 10}} >
             <EText style={{fontSize: 17}} >{item.name} </EText>
        <EText style={{marginTop: 10,fontSize: 15}}>{item.price}</EText>
      ...
      <EText h4 style={{marginStart: 10,marginTop:10}}> Cuisine Combos</EText>

<List.Section title="Combo Dinners"
style={{marginBottom:50}}>
      ...
      /> 
       ...
       <View style={{   position: 'absolute',alignItems: 'center',justifyContent: 'center',right: 150,bottom: 70, }}>
...
buttonStyle={{borderRadius:25,paddingTop:10 , paddingBottom: 10 , paddingStart: 15, paddingEnd: 15}}
       style={{    borderRadius: 30,resizeMode: 'contain',alignItems: 'center',justifyContent: 'center' , alignContent: "center"}}
       title="  MENU"
