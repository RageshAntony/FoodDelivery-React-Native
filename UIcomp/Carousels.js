...
import {FlatList, Image, View, TouchableHighlight} from 'react-native';
import {
  Button,
  Rating,
  Avatar,
            ...
            <View style={{margin: 15, flexDirection: 'column', width: 260}}>
              ...
              <View style={{flexDirection: 'row'}}>
                <Rating
                  ...
                  ratingCount={5}
                />
                <EText style={{fontSize: 15, marginStart: 5}}>
                  {item.rating}{' '}
                </EText>
                <EText style={{fontSize: 15}}>
                  ({item.noReviews} reviews){' '}
                </EText>
              </View>
            </View>
          )}
        ...
        <FlatList
          ...
          renderItem={({item}) => (
            <View
              ...
              <EText style={{fontSize: 15}}>
                {' '}
                {item.availableHotels} Restaurants
              </EText>
            </View>
          )}
        />
            ...
            <TouchableHighlight
              ...
              <View
                ...
                <View
                  ...
                  <EText style={{fontSize: 18, textAlign: 'left'}}>
                    {item.name}{' '}
                  </EText>
                  <EText style={{marginTop: 10, fontSize: 15}}>
                    Briyani,Chinise,Chettinad{' '}
                  </EText>
                  <EText
                    style={{marginTop: 10, fontSize: 15, color: '#8A655D'}}>
                    50 % off | Use SuperIT
                  </EText>
                  <Divider
                    style={{
